...
import { Upload, Link, X, Plus, FileText, Globe, ArrowLeft } from 'lucide-react';
...
export function AddDatasetForm({ onSubmit, onCancel }: AddDatasetFormProps) {
  ...
  const handleSubmit = (data: NewDatasetForm) => {
    onSubmit({
      ...data,
      tags: selectedTags,
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-semibold text-gray-900">Upload New Dataset</h1>
          <p className="text-gray-600">Share your research data with the community</p>
        </div>
      </div>
